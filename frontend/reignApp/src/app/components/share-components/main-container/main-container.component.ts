...
export class MainContainerComponent implements OnInit {
  ...
  public artAuthor: string;
  public artUlr: string;
   ...
   * cleanArticles
   */
  public cleanArticles(): any {
    this.getArticles();
    console.log(Object.entries(this.articles).forEach( art => (art[1] === null ? delete this.articles[art[0]] : 0)));
    //return [];
  }
